            ...
            <div class="container" style="margin-bottom: 280px;">
                ...
                <div class="row" style="border-left: 1px solid black;border-right:1px solid black ;">
                    <div class="col-md-4 col-xs-12 col-sm-4">
                        <p>NOMBRE DEL TRABAJADOR QUE RECIBE:<br> <strong>
                ...
                <div class="row" style="border-left: 1px solid black;border-right:1px solid black ;text-align: center;">
                    ...
                    <div class="col-md-8">
                        <p>NOMBRE DEL TRABAJADOR QUE ENTREGA: <br> <strong>
                ...
                <div class="row" style="border: 1px solid black;">
                    ...
                    <div class="col-md-12" style="padding: 10px;">
                        ...
                        if (!empty($arr_accesorios)) {
                            ...
                            echo '<thead>';
                            echo '<tr>';
                            echo '<th style="padding-right: 20px;text-align: center">Descripción</th>';
                            echo '<th style="padding-right: 20px;text-align: center">Marca</th>';
                            echo '<th style="padding-right: 20px;text-align: center">Modelo</th>';
                ...
                <div class="row">
                    <div class="col-md-12" style="border: 1px solid black;text-align: justify;padding: 10px;">
                        ...
                        <?php
                        if ($empresa == 1) {
                            echo '<p>EL FUNCIONARIO QUE RECIBE, ABAJO FIRMANTE, SE HACE RESPONSABLE DEL USO DEL SOFTWARE INSTALADO
                        ...
                        <p> EL EQUIPO SE ENTREGA A SATISFACCIÓN DEL USUARIO. </p>';
                            ...
                            echo '<p>EL FUNCIONARIO QUE RECIBE, ABAJO FIRMANTE, SE HACE RESPONSABLE DEL USO DEL SOFTWARE INSTALADO EN ESTE(OS) EQUIPO(S) Y APROBADO POR PALMERAS DEL LLANO S.A. BIC Y ASUME LA RESPONSABILIDAD ADMINISTRATIVA Y LEGAL POR EL USO DEL SOFTWARE NO AUTORIZADO.</p>
                        <p> EL EQUIPO SE ENTREGA A SATISFACCIÓN DEL USUARIO. </p>';
                        } elseif ($empresa == 3) {
                            echo '<p>EL FUNCIONARIO QUE RECIBE, ABAJO FIRMANTE, SE HACE RESPONSABLE DEL USO DEL SOFTWARE INSTALADO
                            EN ESTE EQUIPO Y APROBADO POR J25 Y ASUME LA RESPONSABILIDAD,
                            ADMINISTRATIVA Y LEGAL POR EL USO DEL SOFTWARE NO AUTORIZADO. </p>
                        <p> EL EQUIPO SE ENTREGA A SATISFACCIÓN DEL USUARIO. </p>';
                        }
                        ?>
            ...
            <div class="container" style="border: 1px solid black;padding-left: 50px;padding-right: 50px;padding-top: 25px;padding-bottom: 20px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h5 style="margin-left: 60px;margin-top: 15px;">ACUERDO ACTA DE ENTREGA DE EQUIPOS</h5>
                        </div>
                    </div>
                </div>
