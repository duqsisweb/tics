...
if (
    ...
    isset($_POST['fecha_de_ingreso_alma']) && isset($_POST['estado']) && isset($_POST['fecha_de_garantia_alma']) &&
    ...
    isset($_POST['empresa']) && isset($_POST['link_alma_asigna']) && isset($_POST['observaciones_asigna_alma']) 
...
echo "</script>"; {
    ...
    $link_alma_asigna = $_POST['link_alma_asigna'];
    $observaciones_asigna_alma = $_POST['observaciones_asigna_alma'];
    ...
    $queryHistorial = "INSERT INTO ControlTIC..historial_almacenamiento (
        ...
        '$id', '$tipo_maquina', '$marca_almacenamiento', '$modelo_almacenamiento',
        '$descripcion_almacenamiento', '$capacidad_almacenamiento', '$caracteristica_almacenamiento',
        '$sede_almacenamiento', '$ubicacion_almacenamiento', '$fecha_de_ingreso_alma', 'ASIGNADO',
        '$fecha_de_garantia_alma', '$fecha_crea', '$usua_crea', '$fecha_modifica', '$usua_modifica',
        '$primernombre', '$segundonombre', '$primerapellido', '$segundoapellido', '$cedula', '$cargo', '$empresa'
        ,'$observaciones_asigna_alma'
        ,'$link_alma_asigna'
