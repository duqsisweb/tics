    ...
    <body>
        ...
        <section style="margin-top: 100px;">
            ...
            <div class="container-fluid" style="text-align: center;margin-bottom: 30px;">
                <div class="container">
                    <div>
                        <h3>MANTENIMIENTO PREVENTIVO DE COMPUTADORES</h3>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-bordered dt-responsive table-hover display nowrap" id="mtable" cellspacing="0" style="text-align: center;">
                            ...
                            <tbody>
                                ...
                                foreach ($equipos as $equipo) {
                                    ...
                                    echo "<td>" . $equipo['tipo_memoria_ram'] . "</td>";
            ...
            SE DEJA OCULTO -->
            <div>
                <strong id="usuario" style="display: none;!important"><?php echo utf8_encode($_SESSION['usuario']); ?></strong>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(".open-modal").click(function() {
                ...
                $.ajax({
                    ...
                    url: "../ajax_mantenimineto_preventivo/ajax_mantenimiento_preventivo_computador.php", // Reemplaza "tu_script_php.php" con la URL de tu script PHP que maneja la consulta
                    data: {
                        id: equipoId,
                        usuario: usuario // Incluye el contenido de la etiqueta <strong> como parámetro
