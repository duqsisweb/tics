...
if (isset($_SESSION['usuario'])) {
    ...
    if (isset($_POST['consultar'])) {
        ...
        $datosEquipos = hvalmacenamiento($conexion, $id);
                ...
                <table class="table table-bordered dt-responsive table-hover display nowrap" id="" cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['consultar'])) {
                            ...
                            $id = $_POST['id'];
                            // Llamar a la función con el parámetro de búsqueda
                            $datosEquipos = hvalmacenamientocab($conexion, $id);
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['consultar'])) {
                            ...
                            foreach ($datosEquipos as $row) {
                                ...
                                echo "<td>  <a target='_blank' href='" . $row['link_alma_asigna'] . "'>" . $row['link_alma_asigna'] . "</a></td>";
                                echo "<td   class='hidden-cell'>" . $row['observaciones_asigna_alma'] . "</td>";
                                echo "<td>  <button type='button' class='btn btn-success view-button2' data-bs-toggle='modal' data-bs-target='#exampleModal2' data-row-id='" . $row['observaciones_asigna_alma'] . "'>Ver Información</button></td>";
                                echo "<td   class='hidden-cell'>" . $row['observaciones_desasigna_alma'] . "</td>";
                                echo "<td>  <button type='button' class='btn btn-success view-button3' data-bs-toggle='modal' data-bs-target='#exampleModal3' data-row-id='" . $row['observaciones_desasigna_alma'] . "'>Ver Información</button></td>";
                                echo "<td>   <a target='_blank' href='" . $row['link_alma_desasigna'] . "'>" . $row['link_alma_desasigna'] . "</a></td>";
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.view-button').click(function() {
                ...
                var description = $("td:eq(14)", $(this).closest("tr")).text(); // Obtener la descripción de la fila correspondiente
