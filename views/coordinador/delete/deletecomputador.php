...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQuery = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [Estado] = 1 WHERE [id] = '$idToUpdate'";

    $updateQuery2 = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [Gestion] = 3 WHERE [id] = '$idToUpdate'";

    $updateQuery3 = "UPDATE [ControlTIC].[dbo].[asignacion_computador] SET [estado_asignacion] = 'NO VIGENTE' WHERE [id] = '$idToUpdate'";

    $updateQuery4 = "UPDATE [ControlTIC].[dbo].[asignacion_computador] SET [observaciones_desasigna] = '$linkInput' WHERE [id] = '$idToUpdate'";
