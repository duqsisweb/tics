...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQueryy = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [Estado] = 1 WHERE [id] = '$idToUpdate'";
    
    // Consulta SQL para actualizar el estado del registro en la tabla asignacion_computador
    $updateQuery = "DELETE FROM [ControlTIC].[dbo].[asignacion_computador] WHERE [id] = '$idToUpdate'";
