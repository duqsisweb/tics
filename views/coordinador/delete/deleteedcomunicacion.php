...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQuery1 = "UPDATE [ControlTIC].[dbo].[maquina_edcomunicacion] SET [Estado] = 1 WHERE [id] = '$idToUpdate'";

    $updateQuery2 = "UPDATE [ControlTIC].[dbo].[maquina_edcomunicacion] SET [Gestion] = 3 WHERE [id] = '$idToUpdate'";

    $updateQuery3 = "UPDATE [ControlTIC].[dbo].[asignacion_edcomunicacion] SET [estado_asignacion] = 'NO VIGENTE' WHERE [id] = '$idToUpdate'";

    $updateQuery4 = "UPDATE [ControlTIC].[dbo].[asignacion_edcomunicacion] SET [observaciones_desasigna] = '$linkInput' WHERE [id] = '$idToUpdate'";
