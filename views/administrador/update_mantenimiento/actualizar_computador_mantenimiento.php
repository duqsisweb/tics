...
if (
    ...
    &&  isset($_POST['fechaInicioMantenimiento'])
    ...
    $fechaInicioMantenimiento = $_POST['fechaInicioMantenimiento'];
    $fechaFinal = $_POST['fechaFinal'];
    
    // Consulta SQL para actualizar el estado del registro
    $updateQuery = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [Estado] = 6   WHERE [id] = '$idToUpdate'";
