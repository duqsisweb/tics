...
if (
    isset($_POST['idToUpdate'])  &&   isset($_POST['Usua_mantenimiento']) && isset($_POST['observaciones_mantenimiento']) && isset($_POST['Fecha_mantenimiento_inicio']) &&  isset($_POST['Fecha_mantenimiento_fin']) 
