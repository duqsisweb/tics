...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQuery = "UPDATE [ControlTIC].[dbo].[maquina_almacenamiento] SET [estado] = 1 WHERE [id] = '$idToUpdate'";

    $updateQuery2 = "UPDATE [ControlTIC].[dbo].[maquina_almacenamiento] SET [gestion_alma] = 3 WHERE [id] = '$idToUpdate'";

    $updateQuery3 = "UPDATE [ControlTIC].[dbo].[asignacion_almacenamiento] SET [estado_asignacion] = 'NO VIGENTE' WHERE [id] = '$idToUpdate'";

    $updateQuery4 = "UPDATE [ControlTIC].[dbo].[asignacion_almacenamiento] SET [observaciones_desasigna] = '$linkInput' WHERE [id] = '$idToUpdate'";
    
    // Consulta SQL para actualizar el estado del registro en la tabla asignacion_computador
    // $updateQuery4 = "DELETE FROM [ControlTIC].[dbo].[asignacion_computador] WHERE [id] = '$idToUpdate'";
