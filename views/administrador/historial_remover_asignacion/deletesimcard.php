...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQueryy = "UPDATE [ControlTIC].[dbo].[maquina_simcard] SET [Estado] = 6 WHERE [id] = '$idToUpdate'";
    
    // Consulta SQL para actualizar el estado del registro en la tabla asignacion_computador
    $updateQuery = "DELETE FROM [ControlTIC].[dbo].[asignacion_simcard] WHERE [id] = '$idToUpdate'";
