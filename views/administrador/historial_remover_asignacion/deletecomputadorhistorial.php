...
if (
    ...
    && isset($_POST['cedula']) && isset($_POST['cargo']) && isset($_POST['observaciones_desasigna']) 
    && isset($_POST['link_computador_desasigna'])
) {
    ...
    $queryHistorial = "INSERT INTO ControlTIC..historial_computador (
                ...
                primernombre, segundonombre, primerapellido, segundoapellido, cedula, cargo, observaciones_desasigna, link_computador_desasigna,fechamov,descripcionmov,usuamov
            ) VALUES (
                '$id', '$tipo_maquina', '$service_tag', '$serial_equipo', '$nombre_equipo', '$sede', '$empresa',
                '$marca_computador', '$modelo_computador', '$tipo_comp', '$tipo_ram', '$memoria_ram',
                '$tipo_discoduro', '$capacidad_discoduro', '$procesador', '$propietario', '$proveedor',
                '$sistema_operativo', '$serial_cargador', '$dominio', '$tipo_usuario', '$serial_activo_fijo',
                '$Fecha_ingreso_c', '$tarjeta_video', 'CONFIGURACION', 'SIN ASIGNACION', '$Fecha_garantia_c', 
                '$primernombre', '$segundonombre', '$primerapellido', '$segundoapellido','$cedula', '$cargo', '$observaciones_desasigna', '$link_computador_desasigna', CONVERT(datetime, Getdate(), 120),'SE RETIRA ASIGNACION DE UN COMPUTADOR','$Usua_retira')";
