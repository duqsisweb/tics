...
<section class="edcomunicacion-section">
    ...
    if (odbc_num_rows($resultado) > 0) {
        while ($fila = odbc_fetch_array($resultado)) {
            $output .= "-------------------------------------\n";
            $output .= "TOTAL ELEMENTOS DE COMUNICACIÓN DEVUELTOS: " . $fila['TOTAL'] . "\n";
            $output .= "-------------------------------------\n";
        }
    } else {
        $output .= '<div id="" class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Sin retiro de ED COMUNICACIÓN</strong> 
...
<div class="modal fade" id="modaledcomunicacionasigna" tabindex="-1" aria-labelledby="modaledcomunicacionasignaLabel"
    aria-hidden="true">
