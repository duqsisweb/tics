...
if (
    ...
    isset($_POST['cedula']) &&
    isset($_POST['cargo']) 
    && isset($_POST['empresa']) && isset($_POST['observaciones_desasigna_sim']) 
    && isset($_POST['link_sim_desasigna']) && isset($_POST['Usua_asigna'])
    ...
    $observaciones_desasigna_sim = $_POST['observaciones_desasigna_sim'];
    $link_sim_desasigna = $_POST['link_sim_desasigna'];
    ...
    $queryHistorial = "INSERT INTO ControlTIC..historial_simcard (
        ...
        usuamov
         ...
         VALUES (
            ...
            '$observaciones_desasigna_sim',
            '$link_sim_desasigna'
            ,CONVERT(datetime, Getdate(), 120),'SE ELIMINO ASIGNACION DE LA LINEA SIMCARD','$Usua_asigna'
            )";
