...
if (isset($_POST['idToUpdate'])) {
    ...
    $updateQuery = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [Estado] = 4 WHERE [id] = '$idToUpdate'";

    $updateQuery2 = "UPDATE [ControlTIC].[dbo].[maquina_computador] SET [gestion] = 1 WHERE [id] = '$idToUpdate'";

    $updateQuery4 = "DELETE FROM [ControlTIC].[dbo].[asignacion_computador] WHERE [id] = '$idToUpdate' and estado_asignacion = 'NO VIGENTE' ";
