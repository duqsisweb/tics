...
if (isset($_POST['tipo_edcomunicacion'])) {
    ...
    $data = odbc_exec($conexion, "SELECT  [id] ,[tipo_maquina] ,[marca_edcomunicacion] ,[modelo_edcomunicacion] ,[descripcion_edcomunicacion] ,[serial_edcomunicacion] ,[fecha_de_ingreso] ,[estado] ,[placa_activo_edcomunicacion] ,[sede_edcomunicacion] ,[ubicacion_edcomunicacion] ,[observaciones_edcomunicacion] ,[gestion_edcomunicacion] ,[fecha_garantia] ,[fecha_crea] ,[usua_crea] ,[fecha_modifica] ,[usua_modifica] FROM [ControlTIC].[dbo].[maquina_edcomunicacion] where estado = '6' AND [descripcion_edcomunicacion]='$tipo_edcomunicacion' ");
    ...
    <script>
        $(document).ready(function() {
            $('.asignar-btn').on('click', function() {
                ...
                $.ajax({
                    url: 'create/insertaredcomunicacion.php',
                    type: 'POST',
                    data: {
