...
if (isset($_SESSION['usuario'])) {
        ...
        <section style="margin-top: 100px;">
            ...
            <div class="container-fluid" style="text-align: center;margin-bottom: 30px;">
                <div class="container" style="text-align: center;">
                    <div>
                        <h3>HISTORIAL DE EQUIPOS DEVUELTOS POR USUARIO</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3" style="margin: 50px 0px 0px 0px;">
                            ...
                            <select id="empresaSelect" name="empresa" class="form-select"
                        ...
                        <div class="col-md-2" style="margin: 50px 0px 0px 0px;display: none;">
                            ...
                            <input type="text" class="form-control" id="identificacionInput" placeholder="" name="CEDULA"
                        ...
                        <div class="col-md-2" style="margin: 50px 0px 0px 0px;">
                            <div class="form-group">
                                ...
                                <input list="asiste" class="form-control" type="text" id="nombreInput" name="asiste"
                                    required>
                                <datalist id="asiste">
                                    <?php
                                    include '../../../conexionbd.php';
                        ...
                        <div class="col-md-2">
                            <div style="margin: 80px 0px 0px 0px;text-align: center;">
                                <button type="submit" class="btn btn-success" name="consultar"
                        ...
                        <div class="col-md-5">
                            <?php if (isset($showSections) && $showSections): ?>
                                <!-- Comprueba si se debe mostrar la sección -->
                                <div class="card mb-3 <?php echo 'empresa' . $empresaOption; ?>">
                                    <div class="row g-0 background-container">
                                        <?php if (!empty($backgroundImage)): ?>
                                            <!-- Comprueba si hay una imagen de fondo definida -->
                                            <div class="background-image"
                                                style="background-image: url('../../assets/image/<?php echo $backgroundImage; ?>');">
                                            </div>
                                        <?php endif; ?>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <div class="card-body">
                                                    ...
                                                    <input type="hidden" name="empresaOption" id="empresaOption"
                                                        value="<?php echo $empresaOption ?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila3() {
                ...
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichacomputador.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila2() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichacelular.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila3() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichaaccesorios.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <!-- Script y AJAX asignación de ED COMUNICA -->
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila4() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichaedcomunicacion.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila5() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichaperifericos.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila6() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichaalmacenamiento.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila7() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichasimcard.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila8() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichadvr.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila9() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichacctv.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function () {
            ...
            function actualizarFila10() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignacionesusuario/actualizarfichatorre.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
