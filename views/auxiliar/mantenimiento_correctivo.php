                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="mantenimiento_correctivo/mantenimiento_correctivo_computador.php" class="btn btn-success">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_celulares.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_edcomunicacion.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_perifericos.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_almacenamiento.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_simcard.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_dvr.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <img src="../../assets/image/cctv-modified.png" class="card-img-top mx-auto" alt="..." style="width: 150px;">
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_cctv.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <img src="../../assets/image/torre-modified.png" class="card-img-top mx-auto" alt="..." style="width: 150px;">
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a href="stock/stock_torre.php" class="btn btn-success disabled">Seleccionar</a>
                            </div>
                        </div>
                    </div>
                </div>
