...
<section class="almacenamiento-section">
    ...
    WHERE cedula = '$cedula' and descripcionmov LIKE 'SE ELIMINA ASIGNACION DE UNA UNIDAD DE ALMACENAMIENTO' ";
    ...
    if (odbc_num_rows($resultado) > 0) {
        while ($fila = odbc_fetch_array($resultado)) {
            $output .= "-------------------------------------\n";
            $output .= "TOTAL UNIDADES DE ALMACENAMIENTO DEVUELTOS: " . $fila['TOTAL'] . "\n";
            $output .= "-------------------------------------\n";
        }
    } else {
        $output .= '<div id="" class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Sin retiro Disp ALMACENAMIENTO</strong> 
...
<div class="modal fade" id="modalalmacenamiento" tabindex="-1" aria-labelledby="modalalmacenamientoLabel"
    aria-hidden="true">
