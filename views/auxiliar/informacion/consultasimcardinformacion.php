    ...
    <script>
        $(document).ready(function() {
            $('.asignar-btn').on('click', function() {
                ...
                $.ajax({
                    url: 'delete/deletesimcardhistorial.php',
                    type: 'POST',
                    data: {
            ...
            $('.showAlertButton').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // Cerrar el modal
                        $('#modalsimcardinformacion').modal('hide');
                        //mensaje de exito
