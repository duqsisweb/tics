    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila3() {
                ...
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichacomputador.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila2() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichacelular.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila3() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichaaccesorios.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila4() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichaedcomunicacion.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila5() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichaperifericos.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila6() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichaalmacenamiento.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarFila7() {
                var cedula = '<?php echo $cedula; ?>';
                $.ajax({
                    url: 'fichatecnicadesasignaciones/actualizarfichasimcard.php',
                    method: 'GET',
                    data: {
                        cedula: cedula
                    },
