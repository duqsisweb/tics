...
<section class="computadora-section">
    ...
    $cedula = isset($_GET['cedula']) ? $_GET['cedula'] : ''; // Obtener la cédula pasada por AJAX
            ...
            $consulta = " SELECT TOP (1000) [id_asignacion]
                    ,[id]
                    ,[tipo_maquina]
                    ,[Service_tag]
                    ,[Serial_equipo]
                ...
                FROM [ControlTIC].[dbo].[asignacion_computador] WHERE cedula = '$cedula' and estado_asignacion = 'NO VIGENTE' ";
